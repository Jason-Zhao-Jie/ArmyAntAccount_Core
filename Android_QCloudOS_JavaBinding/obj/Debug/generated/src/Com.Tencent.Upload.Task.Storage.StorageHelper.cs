...
namespace Com.Tencent.Upload.Task.Storage {

	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.upload.task.storage']/class[@name='StorageHelper']"
	[global::Android.Runtime.Register ("com/tencent/upload/task/storage/StorageHelper", DoNotGenerateAcw=true)]
	public partial class StorageHelper : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/upload/task/storage/StorageHelper", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (StorageHelper); }
		}
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.upload.task.storage']/class[@name='StorageHelper']/constructor[@name='StorageHelper' and count(parameter)=2 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/lang/String;)V", "")]
		public unsafe StorageHelper (global::Android.Content.Context p0, string p1)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (StorageHelper)) {
					SetHandle (
