...
namespace Com.Tencent.Upload.Task.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']"
	[global::Android.Runtime.Register ("com/tencent/upload/task/impl/PhotoUploadTask", DoNotGenerateAcw=true)]
	public partial class PhotoUploadTask : global::Com.Tencent.Upload.Task.UploadTask {


		static IntPtr CREATOR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/field[@name='CREATOR']"
		[Register ("CREATOR")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/upload/task/impl/PhotoUploadTask", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (PhotoUploadTask); }
		}

		protected PhotoUploadTask (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/constructor[@name='PhotoUploadTask' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register (".ctor", "(Ljava/lang/String;)V", "")]
		public unsafe PhotoUploadTask (string p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (PhotoUploadTask)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/constructor[@name='PhotoUploadTask' and count(parameter)=1 and parameter[1][@type='android.os.Parcel']]"
		[Register (".ctor", "(Landroid/os/Parcel;)V", "")]
		public unsafe PhotoUploadTask (global::Android.OS.Parcel p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.Upload.Task.Impl.PhotoUploadTask __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.Upload.Task.Impl.PhotoUploadTask> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe int BucketSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='getBucketSize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Tencent.Upload.Const.FileType FileType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='getFileType' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='onUploadError' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='onUploadProgress' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='onUploadSucceed' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
		...
		static Delegate cb_setExpired_I;
#pragma warning disable 0169
		static Delegate GetSetExpired_IHandler ()
		{
			if (cb_setExpired_I == null)
				cb_setExpired_I = JNINativeWrapper.CreateDelegate ((Action<IntPtr, IntPtr, int>) n_SetExpired_I);
			return cb_setExpired_I;
		}

		static void n_SetExpired_I (IntPtr jnienv, IntPtr native__this, int p0)
		{
			global::Com.Tencent.Upload.Task.Impl.PhotoUploadTask __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.Upload.Task.Impl.PhotoUploadTask> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
			__this.SetExpired (p0);
		}
#pragma warning restore 0169

		static IntPtr id_setExpired_I;
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='setExpired' and count(parameter)=1 and parameter[1][@type='int']]"
		[Register ("setExpired", "(I)V", "GetSetExpired_IHandler")]
		public virtual unsafe void SetExpired (int p0)
		{
			if (id_setExpired_I == IntPtr.Zero)
				id_setExpired_I = JNIEnv.GetMethodID (class_ref, "setExpired", "(I)V");
			try {
				JValue* __args = stackalloc JValue [1];
				__args [0] = new JValue (p0);

				if (GetType () == ThresholdType)
					JNIEnv.CallVoidMethod  (Handle, id_setExpired_I, __args);
				else
					JNIEnv.CallNonvirtualVoidMethod  (Handle, ThresholdClass, JNIEnv.GetMethodID (ThresholdClass, "setExpired", "(I)V"), __args);
			} finally {
			}
		}
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='PhotoUploadTask']/method[@name='setFileId' and count(parameter)=1 and parameter[1][@type='java.lang.String']]"
		[Register ("setFileId", "(Ljava/lang/String;)V", "GetSetFileId_Ljava_lang_String_Handler")]
		public virtual unsafe void SetFileId (string p0)
		{
