...
namespace FileCloud {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']"
	[global::Android.Runtime.Register ("FileCloud/FileDirStatReq", DoNotGenerateAcw=true)]
	public sealed partial class FileDirStatReq : global::Com.QQ.Taf.Jce.JceStruct {


		static IntPtr auth_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/field[@name='auth']"
		[Register ("auth")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/field[@name='path']"
		[Register ("path")]
		public string Path {
			get {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/field[@name='type']"
		[Register ("type")]
		public int Type {
			get {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("FileCloud/FileDirStatReq", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FileDirStatReq); }
		}

		internal FileDirStatReq (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/constructor[@name='FileDirStatReq' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe FileDirStatReq ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (FileDirStatReq)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/constructor[@name='FileDirStatReq' and count(parameter)=3 and parameter[1][@type='FileCloud.stAuth'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int']]"
		[Register (".ctor", "(LFileCloud/stAuth;Ljava/lang/String;I)V", "")]
		public unsafe FileDirStatReq (global::FileCloud.StAuth p0, string p1, int p2)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/method[@name='readFrom' and count(parameter)=1 and parameter[1][@type='com.qq.taf.jce.JceInputStream']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='FileCloud']/class[@name='FileDirStatReq']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='com.qq.taf.jce.JceOutputStream']]"
