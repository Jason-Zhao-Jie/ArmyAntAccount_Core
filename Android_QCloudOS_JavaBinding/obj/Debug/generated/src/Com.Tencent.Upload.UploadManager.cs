...
namespace Com.Tencent.Upload {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']"
	[global::Android.Runtime.Register ("com/tencent/upload/UploadManager", DoNotGenerateAcw=true)]
	public partial class UploadManager : global::Java.Lang.Object {

		internal static IntPtr java_class_handle;
		internal static IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/upload/UploadManager", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (UploadManager); }
		}

		protected UploadManager (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_content_Context_Ljava_lang_String_Lcom_tencent_upload_Const_FileType_Ljava_lang_String_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/constructor[@name='UploadManager' and count(parameter)=4 and parameter[1][@type='android.content.Context'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='com.tencent.upload.Const.FileType'] and parameter[4][@type='java.lang.String']]"
		[Register (".ctor", "(Landroid/content/Context;Ljava/lang/String;Lcom/tencent/upload/Const$FileType;Ljava/lang/String;)V", "")]
		public unsafe UploadManager (global::Android.Content.Context p0, string p1, global::Com.Tencent.Upload.Const.FileType p2, string p3)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (UploadManager)) {
					SetHandle (
							global::Android.Runtime.JNIEnv.StartCreateInstance (GetType (), "(Landroid/content/Context;Ljava/lang/String;Lcom/tencent/upload/Const$FileType;Ljava/lang/String;)V", __args),
							JniHandleOwnership.TransferLocalRef);
					global::Android.Runtime.JNIEnv.FinishCreateInstance (Handle, "(Landroid/content/Context;Ljava/lang/String;Lcom/tencent/upload/Const$FileType;Ljava/lang/String;)V", __args);
					return;
				}

				if (id_ctor_Landroid_content_Context_Ljava_lang_String_Lcom_tencent_upload_Const_FileType_Ljava_lang_String_ == IntPtr.Zero)
					id_ctor_Landroid_content_Context_Ljava_lang_String_Lcom_tencent_upload_Const_FileType_Ljava_lang_String_ = JNIEnv.GetMethodID (class_ref, "<init>", "(Landroid/content/Context;Ljava/lang/String;Lcom/tencent/upload/Const$FileType;Ljava/lang/String;)V");
				SetHandle (
						global::Android.Runtime.JNIEnv.StartCreateInstance (class_ref, id_ctor_Landroid_content_Context_Ljava_lang_String_Lcom_tencent_upload_Const_FileType_Ljava_lang_String_, __args),
						JniHandleOwnership.TransferLocalRef);
				JNIEnv.FinishCreateInstance (Handle, class_ref, id_ctor_Landroid_content_Context_Ljava_lang_String_Lcom_tencent_upload_Const_FileType_Ljava_lang_String_, __args);
			} finally {
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.Upload.UploadManager __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.Upload.UploadManager> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		public virtual unsafe global::System.Collections.Generic.IList<global::Com.Tencent.Upload.Task.UploadTask> UploadTasks {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='getUploadTasks' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='cancel' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='clear' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='close' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='pause' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='pauseAll' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='resume' and count(parameter)=1 and parameter[1][@type='int']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='resumeAll' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='sendCommand' and count(parameter)=1 and parameter[1][@type='com.tencent.upload.task.CommandTask']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='setBackgroundMode' and count(parameter)=1 and parameter[1][@type='boolean']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='setServerEnv' and count(parameter)=1 and parameter[1][@type='com.tencent.upload.Const.ServerEnv']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='upload' and count(parameter)=1 and parameter[1][@type='com.tencent.upload.task.UploadTask']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload']/class[@name='UploadManager']/method[@name='uploadLog' and count(parameter)=3 and parameter[1][@type='java.lang.String'] and parameter[2][@type='java.util.Date'] and parameter[3][@type='java.util.Date']]"
