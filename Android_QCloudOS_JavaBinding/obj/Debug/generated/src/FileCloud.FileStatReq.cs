...
namespace FileCloud {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']"
	[global::Android.Runtime.Register ("FileCloud/FileStatReq", DoNotGenerateAcw=true)]
	public sealed partial class FileStatReq : global::Com.QQ.Taf.Jce.JceStruct {


		static IntPtr auth_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/field[@name='auth']"
		[Register ("auth")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/field[@name='bucket']"
		[Register ("bucket")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/field[@name='fileid']"
		[Register ("fileid")]
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/field[@name='type']"
		[Register ("type")]
		public int Type {
			get {
		...
		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/field[@name='url']"
		[Register ("url")]
		public string Url {
			get {
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("FileCloud/FileStatReq", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FileStatReq); }
		}

		internal FileStatReq (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/constructor[@name='FileStatReq' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe FileStatReq ()
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/constructor[@name='FileStatReq' and count(parameter)=5 and parameter[1][@type='FileCloud.stAuth'] and parameter[2][@type='java.lang.String'] and parameter[3][@type='int'] and parameter[4][@type='java.lang.String'] and parameter[5][@type='java.lang.String']]"
		[Register (".ctor", "(LFileCloud/stAuth;Ljava/lang/String;ILjava/lang/String;Ljava/lang/String;)V", "")]
		public unsafe FileStatReq (global::FileCloud.StAuth p0, string p1, int p2, string p3, string p4)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/method[@name='readFrom' and count(parameter)=1 and parameter[1][@type='com.qq.taf.jce.JceInputStream']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='FileCloud']/class[@name='FileStatReq']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='com.qq.taf.jce.JceOutputStream']]"
