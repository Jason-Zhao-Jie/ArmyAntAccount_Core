namespace ArmyAntAccount
{
	partial class AboutBox
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelProductName.Text = "账务管理系统 (Windows版)";
			...
			this.labelVersion.Text = "Version : 0.0.1.0";
			...
			this.labelCopyright.Text = "Copyright : ArmyAnt  1/9/2016";
			this.labelCopyright.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// labelAuthorName
			// 
			this.labelAuthorName.Dock = System.Windows.Forms.DockStyle.Fill;
			this.labelAuthorName.Location = new System.Drawing.Point(143, 72);
			this.labelAuthorName.Margin = new System.Windows.Forms.Padding(6, 0, 3, 0);
			this.labelAuthorName.MaximumSize = new System.Drawing.Size(0, 16);
			this.labelAuthorName.Name = "labelAuthorName";
			this.labelAuthorName.Size = new System.Drawing.Size(271, 16);
			this.labelAuthorName.TabIndex = 22;
			this.labelAuthorName.Text = "作者 : Jason";
			this.labelAuthorName.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
			// 
			// textBoxDescription
			// 
