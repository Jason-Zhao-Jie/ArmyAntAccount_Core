...
namespace FileCloud {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='FileCloud']/class[@name='ObjectDeleteRsp']"
	[global::Android.Runtime.Register ("FileCloud/ObjectDeleteRsp", DoNotGenerateAcw=true)]
	public sealed partial class ObjectDeleteRsp : global::Com.QQ.Taf.Jce.JceStruct {


		static IntPtr result_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='FileCloud']/class[@name='ObjectDeleteRsp']/field[@name='result']"
		[Register ("result")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("FileCloud/ObjectDeleteRsp", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (ObjectDeleteRsp); }
		}

		internal ObjectDeleteRsp (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='FileCloud']/class[@name='ObjectDeleteRsp']/constructor[@name='ObjectDeleteRsp' and count(parameter)=0]"
		[Register (".ctor", "()V", "")]
		public unsafe ObjectDeleteRsp ()
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				if (GetType () != typeof (ObjectDeleteRsp)) {
					SetHandle (
		...
		// Metadata.xml XPath constructor reference: path="/api/package[@name='FileCloud']/class[@name='ObjectDeleteRsp']/constructor[@name='ObjectDeleteRsp' and count(parameter)=1 and parameter[1][@type='FileCloud.stResult']]"
		[Register (".ctor", "(LFileCloud/stResult;)V", "")]
		public unsafe ObjectDeleteRsp (global::FileCloud.StResult p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			if (Handle != IntPtr.Zero)
				return;
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='FileCloud']/class[@name='ObjectDeleteRsp']/method[@name='readFrom' and count(parameter)=1 and parameter[1][@type='com.qq.taf.jce.JceInputStream']]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='FileCloud']/class[@name='ObjectDeleteRsp']/method[@name='writeTo' and count(parameter)=1 and parameter[1][@type='com.qq.taf.jce.JceOutputStream']]"
