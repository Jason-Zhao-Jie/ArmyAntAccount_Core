...
namespace Com.Tencent.Upload.Task.Impl {
	...
	// Metadata.xml XPath class reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']"
	[global::Android.Runtime.Register ("com/tencent/upload/task/impl/FileUploadTask", DoNotGenerateAcw=true)]
	public partial class FileUploadTask : global::Com.Tencent.Upload.Task.UploadTask {


		static IntPtr CREATOR_jfieldId;

		// Metadata.xml XPath field reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/field[@name='CREATOR']"
		[Register ("CREATOR")]
		...
		internal static new IntPtr class_ref {
			get {
				return JNIEnv.FindClass ("com/tencent/upload/task/impl/FileUploadTask", ref java_class_handle);
			}
		}
		...
		protected override global::System.Type ThresholdType {
			get { return typeof (FileUploadTask); }
		}

		protected FileUploadTask (IntPtr javaReference, JniHandleOwnership transfer) : base (javaReference, transfer) {}

		static IntPtr id_ctor_Landroid_os_Parcel_;
		// Metadata.xml XPath constructor reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/constructor[@name='FileUploadTask' and count(parameter)=1 and parameter[1][@type='android.os.Parcel']]"
		[Register (".ctor", "(Landroid/os/Parcel;)V", "")]
		public unsafe FileUploadTask (global::Android.OS.Parcel p0)
			: base (IntPtr.Zero, JniHandleOwnership.DoNotTransfer)
		{
			...
			try {
				...
				if (GetType () != typeof (FileUploadTask)) {
					SetHandle (
...
#pragma warning disable 0169
		...
		{
			global::Com.Tencent.Upload.Task.Impl.FileUploadTask __this = global::Java.Lang.Object.GetObject<global::Com.Tencent.Upload.Task.Impl.FileUploadTask> (jnienv, native__this, JniHandleOwnership.DoNotTransfer);
...
#pragma warning restore 0169
		...
		protected override unsafe int BucketSize {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/method[@name='getBucketSize' and count(parameter)=0]"
...
#pragma warning restore 0169
		...
		public virtual unsafe global::Com.Tencent.Upload.Const.FileType FileType {
			// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/method[@name='getFileType' and count(parameter)=0]"
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/method[@name='getFileSha1' and count(parameter)=1 and parameter[1][@type='java.io.File']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/method[@name='onUploadError' and count(parameter)=2 and parameter[1][@type='int'] and parameter[2][@type='java.lang.String']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/method[@name='onUploadProgress' and count(parameter)=2 and parameter[1][@type='long'] and parameter[2][@type='long']]"
...
#pragma warning restore 0169
		...
		// Metadata.xml XPath method reference: path="/api/package[@name='com.tencent.upload.task.impl']/class[@name='FileUploadTask']/method[@name='onUploadSucceed' and count(parameter)=1 and parameter[1][@type='java.lang.Object']]"
